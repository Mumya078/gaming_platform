                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Waiting Cashouts</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Waiting Cashouts</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body p-0">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <th style="width: 70px">Deny</th>
                            </tr>
                            </thead>
                            <tbody>
                                @foreach($cashout as $rs)
                                    <tr>
                                        <td>{{$rs->id}}</td>
                                        ...
                                        <td style="width: 50px"><a href="{{route('accept_cashout',$rs->id)}}"><button class="btn btn-sm btn-success">Accept</button></a></td>
                                        <td style="width: 50px;"><a href="{{route('reject_cashout',$rs->id)}}"><button class="btn btn-sm btn-danger">Deny</button></a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
